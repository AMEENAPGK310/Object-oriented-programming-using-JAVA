...
public class Interfacecase1 {
	...
	{   
		...
		if(co.equals("no"))
		{
		    ...
		    n1.show(name,address,contact,email,type,proofid);
		    }
		    else
		    	n1.update(name,address,contact,mail,type,proofid);
...
interface abc
{
	public void show(String name,String address,int contact,String email,String type,String proofid);
}
interface bcd
{
	public void update(String name, String address, int contact, String mail, String type, String proofid);
}
